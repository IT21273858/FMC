...
export default function Nav({show}){
    ...
    const activeLink= 'flex gap-1 p-1 bg-white text-blue-900 rounded-md '
    ...
    return (
        <aside className={(show? 'left-0':'-left-full')+ "top-0 text-white p-4 fixed w-full bg-blue-300  h-full md:static md:w-auto transition-all"}>
            ...
            <nav className="flex flex-col gap-2">
                <Link href={'/adminuser'} className={pathname === '/adminuser' ? activeLink: inactiveLink}>
