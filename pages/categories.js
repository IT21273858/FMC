                ...
                <div className="mb-2">
                    ...
                    { properties.length > 0 && properties.map((property,index) => (
                            <div className="flex gap-1 mb-2">
                                ...
                                <button type="button" onClick={() => removeProperty(index)} className="btn-default text-sm">Remove</button>
                            </div>
                        ))
                    }
                </div>
                        ...
                        <tr>
                            ...
                            <td className="text-center">
                                <button  className="btn-secondary mr-1 " onClick={()=>editCategory(category)} >
                                    ...
                                    Edit</button>
                                <button  className="btn-secondary mr-1 " onClick={()=>deleteCategory(category)} >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
